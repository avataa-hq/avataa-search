...
from services.hierarchy_services.kafka.consumers.hierarchy_topic.configs import (
    EVENT_HANDLERS_BY_HIERARCHY_EVENT,
)


class HierarchyHierarchiesChangesTopicHandler:
    def __init__(self, kafka_msg: KafkaMSGProtocol):
        self.msg = kafka_msg
        self.msg_instance_class_name = "Hierarchy"
    ...
    def __get_event_handler(self) -> Callable:
        handlers_event_name = EVENT_HANDLERS_BY_HIERARCHY_EVENT.get(
