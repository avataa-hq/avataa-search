...
from services.hierarchy_services.kafka.consumers.obj_topic.configs import (
    EVENT_HANDLERS_BY_OBJ_EVENT,
)


class HierarchyObjChangesTopicHandler:
    def __init__(self, kafka_msg: KafkaMSGProtocol):
        self.msg = kafka_msg
        self.msg_instance_class_name = "Obj"
    ...
    def __get_event_handler(self) -> Callable:
        handlers_event_name = EVENT_HANDLERS_BY_OBJ_EVENT.get(
