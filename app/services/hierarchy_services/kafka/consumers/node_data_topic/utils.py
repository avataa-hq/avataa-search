...
from services.hierarchy_services.kafka.consumers.node_data_topic.configs import (
    EVENT_HANDLERS_BY_NODE_DATA_EVENT,
)


class HierarchyNodeDataTopicHandler:
    def __init__(self, kafka_msg: KafkaMSGProtocol):
        self.msg = kafka_msg
        self.msg_instance_class_name = "NodeData"
    ...
    def __get_event_handler(self) -> Callable:
        handlers_event_name = EVENT_HANDLERS_BY_NODE_DATA_EVENT.get(
