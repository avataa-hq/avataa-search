...
from services.hierarchy_services.kafka.consumers.permission_topic.configs import (
    EVENT_HANDLERS_BY_PERMISSION_EVENT,
)


class HierarchyPermissionChangesTopicHandler:
    def __init__(self, kafka_msg: KafkaMSGProtocol):
        self.msg = kafka_msg
        self.msg_instance_class_name = "Permission"
    ...
    def __get_event_handler(self) -> Callable:
        handlers_event_name = EVENT_HANDLERS_BY_PERMISSION_EVENT.get(
