...
class Sequence(BaseConverter):
    ...
    def to_list(self):
        raise ConvertException("Sequence value cannot be converted to list.")
    ...
    def to_datetime(self):
        try:
            ...
            raise ConvertException(
                "Sequence value cannot be converted to a datetime."
            )
    ...
    def to_date(self):
        try:
            ...
            raise ConvertException(
                "Sequence value cannot be converted to a date."
            )

    def to_formula(self):
        raise ConvertException("Sequence value cannot be converted to formula.")
