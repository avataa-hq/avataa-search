...
async def test_create_level_not_existing(
    async_elastic_session: AsyncElasticsearch, new_level_msg: ListLevel
):
    kfk_msg = KafkaMSGMock(
        msg_key=f"{HierarchyMessageType.LEVEL.value}:{ObjEventStatus.CREATED.value}",
