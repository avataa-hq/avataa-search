...
async def test_with_create_process_case_1(async_elastic_session):
    ...
    await with_create_process(
        message_as_dict=DEFAULT_PROCESS_DATA,
        elastic_client=async_elastic_session,
    )
