...
async def test_process_instance_terminated_case_1(async_elastic_session):
    """TEST with receiving Kafka process instance msg with intent ELEMENT_TERMINATED if mo with process_instance_id
...
async def test_process_instance_terminated_case_2(async_elastic_session):
    """TEST with receiving Kafka process instance msg with intent ELEMENT_TERMINATED if mo with process_instance_id
    exists:
...
@pytest.mark.skip(reason="Not corrected implementing")
async def test_process_instance_terminated_case_3(async_elastic_session):
    """TEST with receiving Kafka process instance msg with intent ELEMENT_TERMINATED if mo with process_instance_id
    exists:
    - creates value of the state
    - state value equals to CANCELED
    ...
    assert new_value == CamundaOperateStatuses.CANCELED.value
